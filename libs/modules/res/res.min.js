...
!function (e) {
    var t = function () {
        ...
        var t = __define, r = e, i = r.prototype;
...
!function (e) {
    var t = function () {
        ...
        var r = (__define, t), i = r.prototype;
...
!function (e) {
    var t = function (t) {
        ...
        __extends(r, t);
        var i = (__define, r), n = i.prototype;
        return n.isGroupInLoading = function (e) {
            ...
            for (; this.loadingCount < this.thread;) {
                ...
                if (!e)break;
                if (this.loadingCount++, e.loaded)this.onItemComplete(e); else {
            ...
            if (r) {
                this.numLoadedDic[r]++;
                var n = this.numLoadedDic[r], s = this.groupTotalDic[r];
...
!function (e) {
    var t = function (t) {
        ...
        return n.loadFile = function (t, r, i) {
            ...
            this.resItemDic[n.hashCode] = {item: t, func: r, thisObject: i}, n.open(e.$getVirtualUrl(t.url)), n.send()
            ...
            var t = e.target, r = this.resItemDic[t.hashCode];
            delete this.resItemDic[t.hashCode];
            var i = r.item, n = r.func;
...
!function (e) {
    var t = function (t) {
        ...
        return n.loadFile = function (t, r, i) {
            ...
            this.resItemDic[n.$hashCode] = {item: t, func: r, thisObject: i}, n.load(e.$getVirtualUrl(t.url))
    ...
    var t = function (t) {
        ...
        return n.getRes = function (t) {
            ...
            if (!this.fileDic[r] && t) {
                ...
                var n = e.data && e.data.subkeys ? "" : r, s = this.parseSpriteSheet(t, i, n);
                this.fileDic[r] = s
            }
            ...
            var i = t.frames;
            if (!i)return null;
            var n = new egret.SpriteSheet(e), s = this.textureMap;
            for (var a in i) {
                var o = i[a], e = n.createTexture(a, o.x, o.y, o.w, o.h, o.offX, o.offY, o.sourceW, o.sourceH);
                if (o.scale9grid) {
                    var u = o.scale9grid, l = u.split(",");
...
!function (e) {
    var t = function (e) {
        ...
        return i.analyzeConfig = function (e, t) {
            ...
            -1 != s && (n = n.substring(s + 6), s = n.indexOf('"'), r = n.substring(0, s)), e = e.split("\\").join("/");
            var s = e.lastIndexOf("/");
...
!function (e) {
    ...
    !function (t) {
        var r = function () {
            ...
            var t = (__define, e), r = t.prototype;
    ...
    var m = function (t) {
        ...
        return n.$getAnalyzerByType = function (e) {
            ...
            for (var n = i.length, s = [], a = 0; n > a; a++) {
                var o = i[a], u = new e.ResourceItem(o.url, o.url, o.type);
                s.push(u)
            }
            var l = {
            ...
            if (t.groupName == r.GROUP_CONFIG) {
                for (var i = this.loadingConfigList.length, n = 0; i > n; n++) {
                    var s = this.loadingConfigList[n], a = this.$getAnalyzerByType(s.type), o = a.getRes(s.url);
            ...
            var s = this.$getAnalyzerByType(n), a = t, o = s.getRes(a);
            if (o)return void egret.$callAsync(r, i, o, t);
            var u = {key: a, compFunc: r, thisObject: i};
            if (this.asyncDic[a])this.asyncDic[a].push(u); else {
                this.asyncDic[a] = [u];
            ...
            if (r && r.length > 0) {
                ...
                for (var n = r.length, s = 0; n > s; s++) {
                    var a = r[s];
                    if (!t && this.isResInLoadedGroup(a.name)); else {
                        a.loaded = !1;
...
!function (e) {
    var t = function (t) {
        ...
        return n.onLoadFinish = function (e) {
            ...
            if (r)if (this.sheetMap[i] = r, r.file)n = this.getRelativePath(e.url, r.file); else {
                var o = e.url.split("?"), u = o[0].split("/");
            ...
            if (!this.fileDic[r] && t) {
                var i = this.sheetMap[r];
                delete this.sheetMap[r];
                var n = e.data && e.data.subkeys ? "" : r, s = this.parseAnimation(t, i, n);
                this.fileDic[r] = s
            }
        }, n.getRelativePath = function (e, t) {
            e = e.split("\\").join("/");
