...
!function (t) {
    var e = function (t) {
        ...
        __extends(e, t);
        var i = __define, r = e, s = r.prototype;
...
!function (t) {
    var e = function (e) {
        ...
        __extends(i, e);
        var r = __define, s = i, n = s.prototype;
        return r(n, "smoothing", function () {
            ...
            if (e) {
                ...
                var i = Math.round(this.offsetPoint.x), r = Math.round(this.offsetPoint.y), s = e._bitmapWidth, n = e._bitmapHeight, o = Math.round(e.$getScaleBitmapWidth()), a = Math.round(e.$getScaleBitmapHeight());
                t.drawImage(e._bitmapData, e._bitmapX, e._bitmapY, s, n, i, r, o, a)
            }
        }, n.$measureContentBounds = function (t) {
            var e = this.$bitmapData;
            if (e) {
                var i = this.offsetPoint.x, r = this.offsetPoint.y, s = e.$getTextureWidth(), n = e.$getTextureHeight();
                t.setTo(i, r, s, n)
            } else t.setEmpty()
            ...
            var i = this, r = e - i.lastTime;
            i.lastTime = e;
            var s = i.frameIntervalTime, n = i.passedTime + r;
            i.passedTime = n % s;
            var o = n / s;
            if (1 > o)return !1;
            for (var a; o >= 1;) {
                if (o--, i.$nextFrameNum++, a = this.frameEvents[i.$nextFrameNum], a && "" != a && t.MovieClipEvent.dispatchMovieClipEvent(i, t.MovieClipEvent.FRAME_LABEL, a), i.$nextFrameNum > i.$totalFrames || i.$frameLabelStart > 0 && i.$nextFrameNum > i.$frameLabelEnd)if (-1 == i.playTimes)i.$eventPool.push(t.Event.LOOP_COMPLETE), i.$nextFrameNum = 1; else {
        ...
        return n.$init = function (t, e, i) {
            ...
            for (var e, i = this.frames, r = t ? t.length : 0, s = 0; r > s; s++) {
                ...
                if (i.push(n), n.duration) {
                    ...
                    if (o > 1) {
                        e = i.length;
                        for (var a = 1; o > a; a++)i.push({frame: e})
                    }
                }
            }
...
!function (t) {
    ...
    var i = function (e) {
        ...
        __extends(i, e);
        var r = (__define, i), s = r.prototype;
        return i.get = function (t, e, r, s) {
            ...
            var s = e._target, n = i._tweens;
            if (r)s && (s.tween_count = s.tween_count > 0 ? s.tween_count + 1 : 1), n.push(e), i._inited || (i._lastTime = t.getTimer(), t.sys.$ticker.$startTick(i.tick, null), i._inited = !0); else {
                s && s.tween_count--;
            ...
            void 0 === i && (i = !1);
            var r = t, s = e, n = -1, o = this._actions.length, a = 1;
            for (t > e && (r = e, s = t, n = o, o = a = -1); (n += a) != o;) {
                var h = this._actions[n], l = h.t;
    ...
    var e = function (e) {
        ...
        return r(n, "bounces", function () {
            ...
            if (void 0 === i && (i = !1), (!i || 0 != t || 0 != e) && (i || this._ScrV_Props_._scrollTop != t || this._ScrV_Props_._scrollLeft != e)) {
                var r = this._ScrV_Props_._scrollTop, s = this._ScrV_Props_._scrollLeft;
                if (i) {
                    var n = this.getMaxScrollLeft(), o = this.getMaxScrollTop();
                    (0 >= r || r >= o) && (t /= 2), (0 >= s || s >= n) && (e /= 2);
                    var a = r + t, h = s + e, l = this._ScrV_Props_._bounces;
            ...
            if (e) {
                var s = this.width, n = this._getContentWidth();
            ...
            if (this._ScrV_Props_._lastTouchPosition.x != t.stageX || this._ScrV_Props_._lastTouchPosition.y != t.stageY) {
                if (!this._ScrV_Props_._scrollStarted) {
                    var e = t.stageX - this._ScrV_Props_._touchStartPosition.x, i = t.stageY - this._ScrV_Props_._touchStartPosition.y, r = Math.sqrt(e * e + i * i);
            ...
            var r = this._getPointChange(e), s = i - this._ScrV_Props_._lastTouchTime;
            ...
            if (0 != this._ScrV_Props_._velocitys.length) {
                for (var t = {x: 0, y: 0}, e = 0, r = 0; r < this._ScrV_Props_._velocitys.length; r++) {
                    var s = this._ScrV_Props_._velocitys[r], n = i.weight[r];
                    t.x += s.x * n, t.y += s.y * n, e += n
                }
                this._ScrV_Props_._velocitys.length = 0, this.scrollSpeed <= 0 && (this.scrollSpeed = 1);
                var o = t.x / e * this.scrollSpeed, a = t.y / e * this.scrollSpeed, h = Math.abs(o), l = Math.abs(a), c = this.getMaxScrollLeft(), u = this.getMaxScrollTop(), _ = h > .02 ? this.getAnimationDatas(o, this._ScrV_Props_._scrollLeft, c) : {
        ...
        }, n._onScrollStarted = function () {
        }, n._onScrollFinished = function () {
            ...
            r != e && s.to({scrollTop: r}, 300, t.ScrollEase.quintOut), this._ScrV_Props_._isVTweenPlaying = !0, this._ScrV_Props_._vScrollTween = s, s.call(this.onTweenFinished, this, [s]), this._ScrV_Props_._isHTweenPlaying || this._onScrollStarted()
            ...
            r != e && s.to({scrollLeft: r}, 300, t.ScrollEase.quintOut), this._ScrV_Props_._isHTweenPlaying = !0, this._ScrV_Props_._hScrollTween = s, s.call(this.onTweenFinished, this, [s]), this._ScrV_Props_._isVTweenPlaying || this._onScrollStarted()
        }, n.getAnimationDatas = function (t, e, i) {
            var r = Math.abs(t), s = .95, n = 0, o = .998, a = .02, h = e + 500 * t;
            if (0 > h || h > i)for (h = e; Math.abs(t) != 1 / 0 && Math.abs(t) > a;)h += t, t *= 0 > h || h > i ? o * s : o, n++; else n = 500 * -Math.log(a / r);
            var l = {position: Math.min(i + 50, Math.max(h, -50)), duration: n};
            return l
...
!function (t) {
    function e(e, i, h) {
        ...
        var u = {listener: e, thisObject: i, delay: h, originDelay: h, params: l};
...
!function (t) {
    function e(e, i, h) {
        for (var l = [], c = 3; c < arguments.length; c++)l[c - 3] = arguments[c];
        var u = {listener: e, thisObject: i, delay: h, params: l};
