...
!function (e) {
    ...
    !function (t) {
        var i = function (i) {
            ...
            __extends(n, i);
            var r = (__define, n), o = r.prototype;
...
!function (e) {
    ...
    !function (t) {
        var i = function (i) {
            ...
            __extends(n, i);
            var r = __define, o = n, s = o.prototype;
    ...
    !function (t) {
        var i = function (i) {
            ...
            return o.load = function (i) {
                ...
                }, {bid: -1, url: t.Html5Capatibility._QQRootPath + i, refresh: 1})
            }, o.play = function (i, n) {
                i = +i || 0, n = +n || 0;
...
!function (e) {
    ...
    !function (t) {
        var i = function (t) {
            ...
            __extends(i, t);
            var n = __define, r = i, o = r.prototype;
            return o.$play = function () {
                ...
                }, {bid: -1, url: t.$url, loop: i}) : QZAppExternal.playLocalBackSound(function (e) {
                }, {bid: -1, url: t.$url, loop: i})
            }, o.stop = function () {
...
!function (e) {
    ...
    !function (t) {
        ...
        var n = function (n) {
            ...
            __extends(r, n);
            var o = (__define, r), s = o.prototype;
            ...
            }, r.MUSIC = "music", r.EFFECT = "effect", r
        }(e.EventDispatcher);
    ...
    !function (t) {
        var i = function (i) {
            ...
            return s.$play = function () {
                ...
                var t = this.context, i = this.gain, n = t.createBufferSource();
    ...
    !function (t) {
        var i = function (t) {
            ...
            return o.load = function (e) {
                ...
                var t = this.bitmapData, i = this.posterData;
                ...
                var i = this.bitmapData, n = this.posterData;
    ...
    !function (t) {
        var i = function (t) {
            ...
            return n(o, "response", function () {
                ...
                var t = this._xhr;
                if (4 == t.readyState) {
                    var i = t.status >= 400 || 0 == t.status, n = (this._url, this);
...
!function (e) {
    ...
    !function (t) {
        var i = window.URL || window.webkitURL, n = function (n) {
            ...
            __extends(r, n);
            var o = __define, s = r, a = s.prototype;
    ...
    !function (t) {
        var i = function (i) {
            ...
            return o.$setTextField = function (e) {
                ...
                var e = this.$textfield.localToGlobal(0, 0), t = e.x, i = e.y, n = this.$textfield.$renderMatrix.a, r = this.$textfield.$renderMatrix.d, o = this.htmlInput.$scaleX, s = this.htmlInput.$scaleY;
                ...
                if (t.multiline) {
                    ...
                    if (t.height < i)this.setElementStyle("height", (t.height + t.lineSpacing) * this._gscaleY + "px"), this.setElementStyle("padding", "0px"); else {
                        this.setElementStyle("height", (i + t.lineSpacing) * this._gscaleY + "px");
                        var n = (t.height - i) * this._gscaleY, r = e.TextFieldUtils.$getValign(t), o = n * r, s = n - o;
                ...
                if (this.inputElement) {
                    ...
                    if (this.setElementStyle("width", i * this._gscaleX + "px"), this.setElementStyle("verticalAlign", t.verticalAlign), t.multiline)this.setAreaHeight(); else if (this.setElementStyle("lineHeight", t.size * this._gscaleY + "px"), t.height < t.size)this.setElementStyle("height", t.height * this._gscaleY + "px"), this.setElementStyle("padding", "0px"); else {
                        this.setElementStyle("height", t.size * this._gscaleY + "px");
                        var n = (t.height - t.size) * this._gscaleY, r = e.TextFieldUtils.$getValign(t), o = n * r, s = n - o;
                        this.setElementStyle("padding", o + "px 0px " + s + "px 0px")
                    }
...
!function (e) {
    ...
    !function (t) {
        var i = function () {
            ...
            var i = (__define, t), n = i.prototype;
            return n.isInputOn = function () {
                ...
                if (this.canvas) {
                    var t = this.canvas.width, i = this.canvas.height, n = this.canvas.style.width.split("px")[0], r = this.canvas.style.height.split("px")[0];
...
!function (e) {
    ...
    !function (e) {
        function t(e) {
            var t = e.stage ? e.stage.$hashCode : 0, i = n[t], s = r[t], a = o[t];
...
!function (e) {
    var t;
    !function (t) {
        var i = [], n = -1 != navigator.userAgent.indexOf("QQBrowser"), r = function () {
            function t() {
            ...
            var r = (__define, t), o = r.prototype;
...
!function (e) {
    ...
    !function (t) {
        var i = function (t) {
            ...
            __extends(i, t);
            var n = (__define, i), r = n.prototype;
            return r.addListeners = function () {
                ...
                var i = document.documentElement, n = this.canvas.getBoundingClientRect(), r = n.left + window.pageXOffset - i.clientLeft, o = n.top + window.pageYOffset - i.clientTop, s = t.pageX - r, a = s, l = t.pageY - o, h = l;
    ...
    !function (t) {
        var i = function (t) {
            ...
            return r.registerListener = function () {
                ...
                var a = navigator.userAgent, l = /micromessenger/gi.test(a), h = /mqq/gi.test(a), u = /mobile.*qq/gi.test(a);
                if ((u || l) && (h = !1), h) {
    ...
    !function (t) {
        ...
        var s = function (t) {
            ...
            return i._init = function () {
                ...
                if (i.ua = t, e.Capabilities.$isMobile = -1 != t.indexOf("mobile") || -1 != t.indexOf("android"), i._canUseBlob = !1, i._audioType = r.HTML5_AUDIO, i._AudioClass = e.web.HtmlSound, i._audioMustLoad = !0, t.indexOf("windows phone") >= 0)i._System_OS = o.WPHONE, i._audioMustLoad = !1, e.Capabilities.$os = "Windows Phone"; else if (t.indexOf("android") >= 0) {
                    if (i._System_OS = o.ADNROID, t.indexOf("ucbrowser") >= 0 && (i._audioMustLoad = !1), e.Capabilities.$os = "Android", i._System_OS = o.ADNROID, window.hasOwnProperty("QZAppExternal") && t.indexOf("qzone") >= 0) {
                        ...
                        if (n && n.length > 0)i._QQRootPath = n[0].baseURI; else {
                            ...
                            -1 == s && (s = window.location.href.length);
                ...
                var t = (navigator.language || navigator.browserLanguage).toLowerCase(), i = t.split("-");
    ...
    !function (t) {
        var i = function () {
            ...
            return t.detect = function () {
                var t = e.Capabilities, i = navigator.userAgent.toLowerCase();
                ...
                var n = (navigator.language || navigator.browserLanguage).toLowerCase(), r = n.split("-");
    ...
    !function (t) {
        var i = function (i) {
            ...
            return o.init = function (i) {
                var n = this.readOption(i), r = new e.Stage;
                ...
                var o = e.sys.surfaceFactory.create(), s = o;
                this.attachCanvas(i, s);
                var a = new t.WebTouchHandler(r, s), l = new e.sys.Player(o.renderContext, r, n.entryClassName), h = new e.web.WebHideHandler(r), u = new t.HTMLInput;
                ...
                var t = this.canvas;
                if (!t.userTyping) {
                    var i = this.playerOption, n = this.container.getBoundingClientRect(), r = !1, o = this.stage.$orientation;
                    o != e.OrientationMode.AUTO && (r = o != e.OrientationMode.PORTRAIT && n.height > n.width || o == e.OrientationMode.PORTRAIT && n.width > n.height);
                    var s = r ? n.height : n.width, a = r ? n.width : n.height, l = e.sys.screenAdapter.calculateStageSize(this.stage.$scaleMode, s, a, i.contentWidth, i.contentHeight), h = l.stageWidth, u = l.stageHeight, d = l.displayWidth, c = l.displayHeight;
...
!function (e) {
    ...
    !function (t) {
        function i(t, i) {
            ...
            if (!n)return null;
            var r = t.$getTextureWidth(), o = t.$getTextureHeight();
            ...
            var h = Math.round(l._offsetX), u = Math.round(l._offsetY), d = l._bitmapWidth, c = l._bitmapHeight;
        ...
        function n(t, n) {
            try {
                var r = i(this, n), o = r.toDataURL(t);
        ...
        function r(e, t, i) {
            ...
            if (null != r) {
                var o = r.replace(/^data:image[^;]*/, "data:image/octet-stream"), s = document.createElement("a");
...
!function (e) {
    ...
    !function (t) {
        ...
        function n(e, t) {
            ...
            var p = i.children;
            for (h = 0; l > h; h++) {
                var g = c[h], v = g.nodeType, f = null;
                if (1 == v)f = n(g, i); else if (3 == v) {
        ...
        var i = function (t) {
            function i(i) {
                ...
                t.call(this), this.onUpdate = function (t) {
                    var i = new e.GeolocationEvent(e.Event.CHANGE), r = t.coords;
    ...
    !function (t) {
        var i = function (t) {
            function i() {
                var i = this;
                t.apply(this, arguments), this.onChange = function (t) {
                    var n = new e.MotionEvent(e.Event.CHANGE), r = {
                        x: t.acceleration.x,
                        y: t.acceleration.y,
                        z: t.acceleration.z
                    }, o = {
                    ...
                    }, s = {alpha: t.rotationRate.alpha, beta: t.rotationRate.beta, gamma: t.rotationRate.gamma};
