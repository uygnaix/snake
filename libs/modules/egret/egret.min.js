...
!function (t) {
    ...
    var e = function () {
        ...
        var i = __define, n = e, r = n.prototype;
...
!function (t) {
    var e = [], i = function (i) {
        ...
        return s.$getEventMap = function (t) {
            ...
            var a = this.$EventDispatcher, o = n ? a[2] : a[1], h = o[t];
            ...
            for (var o = -1, h = t.length, l = 0; h > l; l++) {
                var c = t[l];
                if (c.listener == i && c.thisObject == n && c.target == this)return !1;
                -1 == o && c.priority < s && (o = l)
            }
            var u = {type: e, listener: i, thisObject: n, priority: s, target: this, useCapture: r, dispatchOnce: !!a};
            return -1 !== o ? t.splice(o, 0, u) : t.push(u), !0
        }, s.removeEventListener = function (t, e, i, n) {
            var r = this.$EventDispatcher, s = n ? r[2] : r[1], a = s[t];
            ...
            var n = this.$EventDispatcher, r = i ? n[2] : n[1], s = r[t.$type];
            if (!s)return !0;
            var a = s.length;
            if (0 == a)return !0;
            var o = e;
...
!function (t) {
    ...
    var i = function (i) {
        ...
        __extends(n, i);
        var r = __define, s = n, a = s.prototype;
        return a.$setFlags = function (t) {
            ...
            void 0 === i && (i = !0);
            var n = this.$DisplayObject, r = n[6];
            ...
            if (this.$hasFlags(16)) {
                ...
                var i = this.$DisplayObject, n = i[12], r = i[13], s = this.$scrollRect;
        ...
        }, a.$measureChildBounds = function (t) {
        }, a.$getContentBounds = function () {
            ...
            var e = this.$getConcatenatedMatrix(), i = t || this.$getContentBounds(), n = this.$displayList || this.$parentDisplayList, r = this.$renderRegion;
            ...
            if (n) {
                var r = this.$getInvertedConcatenatedMatrix(), s = r.a * e + r.c * i + r.tx, a = r.b * e + r.d * i + r.ty, o = t.Rectangle.create();
                o.setTo(s, a, 3, 3);
            ...
            var r = this.$getInvertedConcatenatedMatrix(), g = this.getBounds(null, !1), s = r.a * e + r.c * i + r.tx, a = r.b * e + r.d * i + r.ty;
            if (g.contains(s, a)) {
            ...
            if (l || e == t.Event.RENDER) {
                var c = l ? n.$enterFrameCallBackList : n.$renderCallBackList;
...
!function (t) {
    var e = function (e) {
        ...
        __extends(i, e);
        var n = __define, r = i, s = r.prototype;
        return s.$onAddToStage = function (i, n) {
            ...
            var e = this.$Bitmap;
            if (e[1]) {
                var n = isNaN(e[11]) ? e[8] : e[11], r = isNaN(e[12]) ? e[9] : e[12];
            ...
            var n, r, s = this.$getInvertedConcatenatedMatrix(), a = s.a * e + s.c * i + s.tx, o = s.b * e + s.d * i + s.ty, h = this.$displayList;
            if (h) {
                n = h.renderContext;
                try {
            ...
            if (n)if (e.imageSmoothingEnabled = $, g)i.$drawScale9GridImage(e, n, g, r, s, a, o, h, l, c, u, d, f); else if (p == t.BitmapFillMode.SCALE) {
                var v = d / c, y = f / u;
                e.drawImage(n, r, s, a, o, h * v, l * y, v * a, y * o)
            } else if (p == t.BitmapFillMode.CLIP) {
                var x = Math.min(c, d), m = Math.min(u, f);
            ...
            var $ = n.x - h, v = n.y - l, y = $ / t.$TextureScaleFactor, x = v / t.$TextureScaleFactor, m = n.width / t.$TextureScaleFactor, T = n.height / t.$TextureScaleFactor;
            0 == T && (T = 1, x >= p && x--), 0 == m && (m = 1, y >= g && y--);
            var _ = r, b = _ + y, C = b + m, F = g - y - m, E = s, R = E + x, S = R + T, w = p - x - T, L = F * t.$TextureScaleFactor, O = w * t.$TextureScaleFactor;
            if ((y + F) * t.$TextureScaleFactor > d || (x + w) * t.$TextureScaleFactor > f)return void e.drawImage(i, r, s, a, o, h, l, d, f);
            var D = h, M = D + $, I = D + (d - L), A = d - $ - L, B = l, N = B + v, P = B + f - O, k = f - v - O;
...
!function (t) {
    var e = function (e) {
        ...
        return s.$propagateFlagsDown = function (t) {
            ...
            var n = this.$children, r = n[t], s = n[e];
        ...
        }, s.$childAdded = function (t, e) {
        }, s.$childRemoved = function (t, e) {
        }, s.$onAddToStage = function (t, i) {
            ...
            var n = this.$getInvertedConcatenatedMatrix(), r = n.a * t + n.c * i + n.tx, s = n.b * t + n.d * i + n.ty, a = this.$scrollRect ? this.$scrollRect : this.$maskRect;
...
!function (t) {
    var e = function (e) {
        ...
        return n(s, "graphicsRenderContext", function () {
            ...
            var n = this.$renderContext.$targetDisplay, r = n.$getInvertedConcatenatedMatrix(), s = r.a * e + r.c * i + r.tx, a = r.b * e + r.d * i + r.ty, o = t.sys.hitTestRenderContext;
            ...
            var i = 255 & t, n = (65280 & t) >> 8, r = t >> 16;
            return "rgba(" + r + "," + n + "," + i + "," + e + ")"
            ...
            var a = t.sys.surfaceFactory.create(!0), o = a.renderContext, h = new t.Matrix;
            ...
            var a = t, o = e, h = i, l = n, c = r / 2, u = s ? s / 2 : c, d = a + h, f = o + l, g = d, p = f - u;
            ...
            var r = t + i / 2, s = e + n / 2, a = i > n ? i : n, o = i / a, h = n / a;
...
!function (t) {
    ...
    var s = Math.PI, a = s / 2, o = s + a, h = 2 * s, l = {x: 0, y: 0}, c = {x: 0, y: 0}, u = {
        x: 0,
        y: 0
    }, d = function (d) {
        function f() {
        ...
        __extends(f, d);
        var g = __define, p = f, $ = p.prototype;
        return f.createRadialGradient = function (e, i, n, r, s, a) {
            ...
            r > l && (l += h);
            var c = Math.cos(r) * n, u = Math.cos(l) * n, d = Math.min(c, u), f = Math.max(c, u), g = Math.sin(r) * n, p = Math.sin(l) * n, $ = Math.min(g, p), v = Math.max(g, p);
            ...
            if (this.pushCommand(18, arguments), !isNaN(this.moveToX)) {
                ...
                var d = c.x * l.x + c.y * l.y, f = i(c.x, c.y, 0, 0), g = i(l.x, l.y, 0, 0), p = d / (f * g), $ = Math.acos(p), v = h / Math.sin($), y = t + l.x * v, x = r + l.y * v, m = h / Math.tan($), T = t + c.x * m, _ = r + c.y * m, b = t + u.x * m, C = r + u.y * m;
                n(y, x, T, _, l);
                var F = Math.atan2(l.y, l.x);
                n(y, x, b, C, l);
                var E = Math.atan2(l.y, l.x), R = E - F;
                if (R = e(R), R > s) {
                    var S = E;
                    E = F, F = S
                }
            ...
            this.$commands.push({type: t, arguments: e}), this.$targetDisplay.$invalidateContentBounds()
            ...
            if (this.hasStroke || this._strokeStyle)var e = this._maxLineWidth, i = .5 * e; else i = e = 0;
            ...
            var i = t.graphicsMap;
            i || (i = r(t));
            var n = this.$commands, s = n.length;
    ...
    var e = function (e) {
        ...
        return n(s, "textureWidth", function () {
            ...
            if (e instanceof i ? e._bitmapData && (n = e._bitmapData.hashCode) : n = e.hashCode, n && i._displayList[n]) {
                var r = i._displayList[n], s = r.indexOf(t);
                s >= 0 && r.splice(s)
            }
...
var egret;
!function (t) {
    var e = ["source-over", "lighter", "destination-out"], i = "source-over", n = function (n) {
        function r() {
            n.call(this), this.$displayListMap = {}
        }

        __extends(r, n);
        var s = r, a = s.prototype;
        return a.drawToTexture = function (e, i, n) {
            ...
            var s = r.x + r.width, a = r.y + r.height;
            ...
            var c = e.$renderMatrix, u = t.Matrix.create();
            ...
            var a = 0, o = 0 !== n.$blendMode;
            if (o) {
                var h = e[n.$blendMode];
                h || (h = i)
            }
            var l, c = n.$scrollRect, u = n.$mask, d = n.$getConcatenatedMatrix();
            if (u) {
            ...
            var r = 0, s = e.$scrollRect ? e.$scrollRect : e.$maskRect;
            if (0 == s.width || 0 == s.height)return r;
            var a = e.$getConcatenatedMatrix(), o = t.sys.Region.create();
...
!function (t) {
    var e = function (e) {
        ...
        return n(s, "graphics", function () {
            ...
            if (!this.$visible)return null;
            var n = this.$getInvertedConcatenatedMatrix(), r = n.a * e + n.c * i + n.tx, s = n.b * e + n.d * i + n.ty, a = this.$scrollRect ? this.$scrollRect : this.$maskRect;
            if (a && !a.contains(r, s))return null;
...
!function (t) {
    var e = function (t) {
        ...
        return i(r, "type", function () {
            ...
            void 0 === n && (n = !1);
            var s = e.create(e, i, n), a = e._getPropertyData(e);
            void 0 != r && (a.data = r);
...
!function (t) {
    var e = function (e) {
        ...
        return i.dispatchIOErrorEvent = function (e) {
            var n = t.Event.create(i, i.IO_ERROR), r = e.dispatchEvent(n);
...
!function (t) {
    var e = function (e) {
        ...
        return i.dispatchStageOrientationEvent = function (e, n) {
            var r = t.Event.create(i, n), s = e.dispatchEvent(r);
            return t.Event.release(r), s
...
!function (t) {
    var e = function (e) {
        ...
        return r.updateAfterEvent = function () {
            ...
            var a = t.Event.create(i, n, r, s), o = e.dispatchEvent(a);
            return t.Event.release(a), o
...
!function (t) {
    var e = [], i = Math.PI / 180, n = function (n) {
        ...
        __extends(r, n);
        var s = __define, a = r, o = a.prototype;
...
!function (t) {
    ...
    var n = Math.PI, r = n / 2, s = n + r, a = 2 * n, o = Math.PI / 180, h = [], l = function (r) {
        ...
        return s.release = function (t) {
            ...
            var e = this.a, i = this.b, n = this.c, r = this.d, s = this.tx, a = this.ty;
            ...
            if (t = +t, 0 !== t) {
                var n = e(t), r = i(t), s = this.a, a = this.b, o = this.c, h = this.d, l = this.tx, c = this.ty;
            ...
            var r = this.a * e + this.c * i + this.tx, s = this.b * e + this.d * i + this.ty;
            ...
            var a = this.a, o = this.b, h = this.c, l = this.d;
            ...
            var i = this, n = i.a * e.x + i.c * e.y, r = i.b * e.x + i.d * e.y;
            ...
            var e = this.a, i = this.b, n = this.c, r = this.d, s = this.tx, a = this.ty, o = t.x, h = t.y, l = o + t.width, c = h + t.height, u = e * o + n * h + s, d = i * o + r * h + a, f = e * l + n * h + s, g = i * l + r * h + a, p = e * l + n * c + s, $ = i * l + r * c + a, v = e * o + n * c + s, y = i * o + r * c + a, x = 0;
            ...
            var i = t.a * this.a, n = 0, r = 0, s = t.d * this.d, a = t.tx * this.a + this.tx, o = t.ty * this.d + this.ty;
...
!function (t) {
    var e = [], i = function (i) {
        ...
        return n.release = function (t) {
            ...
            var e = this.x, i = this.y, n = t.x, r = t.y, s = Math.max(e, n), a = Math.min(e + this.width, n + t.width);
            if (a >= s) {
                var o = Math.max(i, r), h = Math.min(i + this.height, r + t.height);
            ...
            var e = t.x + t.width, i = t.y + t.height, n = this.x + this.width, r = this.y + this.height;
...
!function (t) {
    ...
    !function (e) {
        function i(t, e) {
            var i = t.minX < e.minX ? t.minX : e.minX, n = t.minY < e.minY ? t.minY : e.minY, r = t.maxX > e.maxX ? t.maxX : e.maxX, s = t.maxY > e.maxY ? t.maxY : e.maxY;
            return (r - i) * (s - n)
        }
        ...
        var n = function () {
            ...
            return s.setClipRect = function (t, e) {
                ...
                var n = i.minX, r = i.minY, s = i.maxX, a = i.maxY;
                ...
                for (var r = this.hasClipRect, s = n > 3 ? Number.POSITIVE_INFINITY : 0, a = 0, o = 0, h = 0, l = 0; n - 1 > l; l++) {
                    ...
                    r && (h += c.area);
                    for (var u = l + 1; n > u; u++) {
                        var d = t[u], f = i(c, d) - c.area - d.area;
                        s > f && (a = l, o = u, s = f)
                    }
                }
...
!function (t) {
    var e;
    !function (e) {
        var i = [], n = ["source-over", "lighter", "destination-out"], r = "source-over", s = function (s) {
            function a(i) {
            ...
            return a.release = function (n) {
                ...
                var e = t.$getConcatenatedMatrix(), i = t.$getOriginalBounds(), n = t.$parentDisplayList, r = 1;
                ...
                if (r ? (r.needRedraw && (h += r.drawToSurface()), a = r, o = 1) : t.$renderRegion && (a = t, o = t.$renderAlpha), a) {
                    ...
                    if (s && !s.intersects(l))a.$isDirty = !1; else if (!a.$isDirty)for (var c = i.length, u = 0; c > u; u++)if (l.intersects(i[u])) {
                        a.$isDirty = !0;
                        break
                    }
                    if (a.$isDirty) {
                ...
                var l = 0, c = 0 !== i.$blendMode;
                if (c) {
                    var u = n[i.$blendMode];
                    u || (u = r)
                }
                var d = i.$scrollRect ? i.$scrollRect : i.$maskRect, f = i.$mask;
                ...
                var o = 0, h = i.$scrollRect ? i.$scrollRect : i.$maskRect;
                ...
                var i = (this.root, this.offsetX), n = this.offsetY, r = this.root.$getOriginalBounds(), s = this.$pixelRatio, a = this.$pixelRatio;
                this.offsetX = r.x, this.offsetY = r.y;
                var o = this.renderContext, h = o.surface;
                if (this.sizeChanged) {
                    var l = e.sharedRenderContext, c = l.surface;
    ...
    !function (e) {
        function i(i, n, r, s) {
            if (n && (t.log = function () {
                ...
                var o = void 0 === s.x ? 0 : s.x, u = void 0 === s.y ? 0 : s.y;
        ...
        var o = function (a) {
            ...
            return l.createDisplayList = function (t, i) {
                ...
                var n = this.stage, r = t.getTimer(), s = n.$displayList.updateDirtyRegions(), a = t.getTimer();
                s = s.concat();
        ...
        e.$logToFPS = function (t) {
            ...
            return __extends(i, e), i.prototype.createDisplay = function () {
                ...
                if (this.totalTime += a - this.lastTime, this.lastTime = a, this.totalTick++, this.drawCalls += e, this.dirtyRatio += i, this.costDirty += n, this.costRender += r, this.costTicker += s, this.totalTime > 500) {
                    var o = Math.round(1e3 * this.totalTick / this.totalTime), h = Math.round(this.drawCalls / this.totalTick), l = Math.round(this.dirtyRatio / this.totalTick), c = Math.round(this.costDirty / this.totalTick), u = Math.round(this.costRender / this.totalTick), d = Math.round(this.costTicker / this.totalTick), f = "FPS: " + o + "\nDraw: " + h + "," + l + "%\nCost: " + d + "," + c + "," + u;
    ...
    !function (e) {
        var i = [], n = function () {
            ...
            return t.release = function (t) {
                ...
                var i, n, r, s, a = e, o = a.a, h = a.b, l = a.c, c = a.d, u = a.tx, d = a.ty, f = t.x, g = t.y, p = f + t.width, $ = g + t.height;
                if (1 == o && 0 == h && 0 == l && 1 == c)i = Math.floor(f + u) - 1, n = Math.floor(g + d) - 1, r = Math.ceil(p + u) + 1, s = Math.ceil($ + d) + 1; else {
                    var v = o * f + l * g + u, y = h * f + c * g + d, x = o * p + l * g + u, m = h * p + c * g + d, T = o * p + l * $ + u, _ = h * p + c * $ + d, b = o * f + l * $ + u, C = h * f + c * $ + d, F = 0;
    ...
    !function (e) {
        var i = function (e) {
            ...
            return r.calculateStageSize = function (e, i, n, r, s) {
                var a = i, o = n, h = r, l = s, c = i / h || 0, u = n / l || 0;
                switch (e) {
                ...
                return {stageWidth: h, stageHeight: l, displayWidth: a, displayHeight: o}
            }, i
        }(t.HashObject);
    ...
    !function (e) {
        ...
        var i = function () {
            ...
            return r.$addPlayer = function (t) {
                ...
                var n = this.playerList, r = n.length;
                if (0 != r) {
        ...
        var i = function (e) {
            ...
            return r.$initMaxTouches = function () {
                ...
                if (null != this.touchDownTarget[n]) {
                    var r = this.findTarget(e, i), s = this.touchDownTarget[n];
    ...
    var e = function (t) {
        ...
        return n.getTexture = function (t) {
            ...
            for (var e = t.split("\n"), i = this.getConfigByKey(e[3], "count"), n = {}, r = 4; 4 + i > r; r++) {
                var s = e[r], a = String.fromCharCode(this.getConfigByKey(s, "id")), o = {};
...
!function (t) {
    var e = function (e) {
        ...
        return n(s, "smoothing", function () {
            ...
            var n = this, r = n.$BitmapText, s = n.$getTextLines(), a = s.length;
            if (0 != a)for (var o = n.$textLinesWidth, h = r[5], l = h._getFirstCharHeight(), c = Math.ceil(l * i.EMPTY_FACTOR), u = !isNaN(r[1]), d = r[8], f = r[0], g = r[1], p = r[10], $ = n.$textOffsetY + n.$textStartY, v = n.$lineHeights, y = 0; a > y; y++) {
                var x = v[y];
                if (u && y > 0 && $ + x > g)break;
                var m = s[y], T = m.length, _ = n.$textOffsetX;
                ...
                for (var C = 0; T > C; C++) {
                    var F = m.charAt(C), E = h.getTexture(F);
                    if (E) {
                        var R = E._bitmapWidth, S = E._bitmapHeight;
            ...
            for (var h = r[3], l = r[4], c = 0, u = 0, d = 0, f = 0, g = !isNaN(r[0]), p = r[0], $ = r[1], v = r[5], y = v._getFirstCharHeight(), x = Math.ceil(y * i.EMPTY_FACTOR), m = r[2], T = m.split(/(?:\r\n|\r|\n)/), _ = T.length, b = !0, C = 0; _ > C; C++) {
                for (var F = T[C], E = F.length, R = 0, S = 0, w = !0, L = !1, O = 0; E > O; O++) {
                    w || (S += l);
                    var D, M, I = F.charAt(O), A = 0, B = 0, N = v.getTexture(I);
                    if (N)D = N.$getTextureWidth(), M = N.$getTextureHeight(), A = N._offsetX, B = N._offsetY; else {
                        if (" " != I) {
                            t.$warn(1011, I), w && (w = !1);
                            continue
                        }
    ...
    var e = function () {
        ...
        return n.initReplaceArr = function () {
            ...
            for (var i = 0, n = e.length; n > i;) {
                var r = e.indexOf("<", i);
                if (0 > r)this.addToResultArr(e.substring(i)), i = n; else {
                    this.addToResultArr(e.substring(i, r));
                    var s = e.indexOf(">", r);
                    -1 == s ? (t.$error(1038), s = r) : "/" == e.charAt(r + 1) ? this.stackArray.pop() : this.addToArray(e.substring(r + 1, s)), i = s + 1
                }
            }
            ...
            if ("i" == t.charAt(0) || "b" == t.charAt(0) || "u" == t.charAt(0))this.addProperty(e, t, "true"); else if (i = t.match(/^(font|a)\s/)) {
                ...
                for (var n, r = 0; n = t.match(this.getHeadReg());) {
                    var s = n[0], a = "", t = t.substring(s.length).trim();
                    if ('"' == t.charAt(0)) {
                        var r = t.indexOf('"', 1);
...
!function (t) {
    var e = function (e) {
        ...
        return r.init = function (e) {
            ...
            var i = this._text.$TextField, n = this.stageText.$getText(), r = !1;
            if (null != i[35]) {
                var s = new RegExp("[" + i[35] + "]", "g"), a = n.match(s);
                n = a ? a.join("") : "", r = !0
            }
...
!function (t) {
    ...
    function i(t, e, i) {
        void 0 === i && (i = null), i = i || {};
        var n = null == i.italic ? e.$TextField[16] : i.italic, s = null == i.bold ? e.$TextField[15] : i.bold, a = null == i.size ? e.$TextField[0] : i.size, o = i.fontFamily || e.$TextField[8] || r.default_fontFamily, h = n ? "italic " : "normal ";
        h += s ? "bold " : "normal ", h += a + "px " + o, t.font = h, t.textAlign = "left", t.textBaseline = "middle", t.lineJoin = "round"
    }

    var n = new RegExp("(?=[\\u00BF-\\u1FFF\\u2C00-\\uD7FF]|\\b|\\s)(?![。，！、》…）)}”】\\.\\,\\!\\?\\]\\:])"), r = function (r) {
        function s() {
        ...
        __extends(s, r);
        var a = __define, o = s, h = o.prototype;
        return h.isInput = function () {
            ...
            if (null == t && (t = ""), t = t.toString(), this.isFlow = !1, this.$TextField[13] != t) {
                ...
                var e = "";
                return e = this.$TextField[20] ? this.changeToPassText(t) : t, this.setMiddleStyle([{text: e}]), !0
            }
            return !1
            ...
            if (this.$TextField[20] != t) {
                ...
                var e = "";
                return e = t ? this.changeToPassText(this.$TextField[13]) : this.$TextField[13], this.setMiddleStyle([{text: e}]), !0
            }
            return !1
            ...
            var i = this, e = i.$getContentBounds(), n = t.Rectangle.create();
            ...
            var i = this;
            this.$getLinesArr();
            var n = isNaN(this.$TextField[3]) ? this.$TextField[5] : this.$TextField[3], r = isNaN(this.$TextField[4]) ? t.TextFieldUtils.$getTextHeight(i) : this.$TextField[4];
            e.setTo(0, 0, n, r)
        }, h.$render = function (e) {
            ...
            e.$TextField[18] = !1;
            var r = e.textArr, s = t.sys.sharedRenderContext;
                ...
                for (var $ = p.text.toString(), v = $.split(/(?:\r\n|\r|\n)/), y = 0, x = v.length; x > y; y++) {
                    ...
                    if ("" == v[y])y == x - 1 && (m = !1); else {
                        ...
                        if (isNaN(a))l += T, c += v[y].length, o.elements.push({
                            ...
                            text: v[y],
                            style: p.style
                        }), y == x - 1 && (m = !1); else if (a >= l + T)o.elements.push({
                            width: T,
                            text: v[y],
                            style: p.style
                        }), l += T, c += v[y].length, y == x - 1 && (m = !1); else {
                            var _ = 0, b = 0, C = v[y];
                            if (this.$TextField[19])var F = C.split(n); else F = C.match(/./g);
                            for (var E = F.length, R = 0; E > _ && (T = s.measureText(F[_]).width, !(0 != l && l + T > a && l + _ != 0)); _++)R += F[_].length, b += T, l += T, c += R;
                            if (_ > 0) {
                                o.elements.push({width: b, text: C.substring(0, R), style: p.style});
            ...
            var n = this, r = this.$TextField, s = n.$getLinesArr();
            if (0 != r[5]) {
                var a = isNaN(r[3]) ? r[5] : r[3], o = t.TextFieldUtils.$getTextHeight(n), h = 0, l = t.TextFieldUtils.$getStartLine(n), c = r[4];
                if (!isNaN(c) && c > o) {
                ...
                for (var d = t.TextFieldUtils.$getHalign(n), f = 0, g = l, p = r[29]; p > g; g++) {
                    ...
                    for (var y = 0, x = $.elements.length; x > y; y++) {
                        var m = $.elements[y], T = m.style.size || r[0];
...
!function (t) {
    var e = function () {
        ...
        return e.$getStartLine = function (t) {
            var i = t.$TextField, n = e.$getTextHeight(t), r = 0, s = i[4];
            ...
            var n = e.$getTextHeight(i), r = i.$TextField[4];
            if (!isNaN(r) && r > n) {
                var s = 0;
            ...
            var r = e.$getHit(t, i, n), s = t.$getLinesArr();
            ...
            var s = 0, a = e.$getTextHeight(t), o = 0, h = t.$TextField[4];
            if (!isNaN(h) && h > a) {
                var l = e.$getValign(t);
                o = l * (h - a), 0 != o && (n -= o)
            }
            ...
            for (d = 0; d < g.elements.length; d++) {
                var $ = g.elements[d];
                if (!(p + $.width < i))return {lineIndex: s - 1, textElementIndex: d};
                p += $.width
            }
            return null
            ...
            var e = 1;
            if (t.$TextField[30]) {
                var i = t.height, n = t.size, r = t.lineSpacing;
                e = Math.floor(i / (n + r));
                var s = i - (n + r) * e;
                s > n / 2 && e++
            }
...
!function (t) {
    ...
    var i = function () {
        ...
        return s._setArrayBuffer = function (t) {
            ...
            var n = this.encodeUTF8(t), r = n.length;
            ...
            if (void 0 === e && (e = !1), this.write_position = t > this.write_position ? t : this.write_position, t += this._position, this.data.byteLength < t || e) {
                var i = new Uint8Array(new ArrayBuffer(t + this.BUFFER_EXT_SIZE)), n = Math.min(this.data.buffer.byteLength, t + this.BUFFER_EXT_SIZE);
            ...
            for (var e, i = !1, n = 0, r = "", s = 0, a = 0, o = 0, h = 0; t.length > n;) {
                var l = t[n++];
                if (l == this.EOF_byte)e = 0 != a ? this.decoderError(i) : this.EOF_code_point; else if (0 == a)this.inRange(l, 0, 127) ? e = l : (this.inRange(l, 194, 223) ? (a = 1, h = 128, s = l - 192) : this.inRange(l, 224, 239) ? (a = 2, h = 2048, s = l - 224) : this.inRange(l, 240, 244) ? (a = 3, h = 65536, s = l - 240) : this.decoderError(i), s *= Math.pow(64, a), e = null); else if (this.inRange(l, 128, 191))if (o += 1, s += (l - 128) * Math.pow(64, a - o), o !== a)e = null; else {
                    var c = s, u = h;
            ...
            for (var e = [], i = 0, n = t.length; i < t.length;) {
                ...
                if (this.inRange(r, 55296, 57343))if (this.inRange(r, 56320, 57343))e.push(65533); else if (i == n - 1)e.push(65533); else {
                    var s = t.charCodeAt(i + 1);
                    if (this.inRange(s, 56320, 57343)) {
                        var a = 1023 & r, o = 1023 & s;
...
!function (t) {
    function e(t, e, i) {
        ...
        var s, a = t.prototype;
        t.hasOwnProperty("__sets__") || Object.defineProperty(t, "__sets__", {value: {}}), s = t.__sets__;
        var o = s[i];
...
!function (t) {
    function e(t) {
        ...
        var n = i.constructor.toString(), r = n.indexOf("("), s = n.substring(9, r);
        return Object.defineProperty(i, "__class__", {value: s, enumerable: !1, writable: !0}), s
    }
...
!function (t) {
    var e = function () {
        ...
        var e = __define, i = t;
        i.prototype;
        return e(t, "logLevel", void 0, function (t) {
