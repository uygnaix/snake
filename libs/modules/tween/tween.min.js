...
!function (t) {
    var n = function (n) {
        ...
        return e.get = function (t, n, i, s) {
            ...
            var s = n._target, u = e._tweens;
            if (i)s && (s.tween_count = s.tween_count > 0 ? s.tween_count + 1 : 1), u.push(n), e._inited || (e._lastTime = t.getTimer(), t.sys.$ticker.$startTick(e.tick, null), e._inited = !0); else {
                s && s.tween_count--;
            ...
            var s = this._prevPos;
            if (this.position = this._prevPos = e, this._prevPosition = t, this._target)if (i)this._updateTargetProps(null, 1); else if (this._steps.length > 0) {
            ...
            void 0 === e && (e = !1);
            var i = t, s = n, u = -1, r = this._actions.length, o = 1;
            for (t > n && (i = n, s = t, u = r, r = o = -1); (u += o) != r;) {
                var a = this._actions[u], h = a.t;
            ...
            return this._addStep({d: t, p0: e, p1: e, v: n})
        }, s.to = function (t, n, e) {
            ...
            return void 0 === n && (n = null), this._addAction({f: this._set, o: this, p: [t, n ? n : this._target]})
        }, s.play = function (t) {
